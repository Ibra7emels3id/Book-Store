...
const Header = () => {
    ...
    return (
        <>
            <Navbar fluid className=' bg-white dark:bg-background px-[20px] lg:px-[80px] m-auto z-10'>
                <NavbarBrand href="/">
                ...
                <div className="flex md:order-2 gap-4">
                    <div className="flex">
                        {user ?
                            <Dropdown
                                label={<Avatar alt="User settings" img="/assets/images/3d-render-avatar-character_23-2150611765.avif" rounded />}
                                arrowIcon={false}
                                inline
                            >
                                <Dropdown.Header>
                                ...
                                <Dropdown.Item>
                                    {stateUser === 'admin' && <Link href={'/admin'} className="block text-sm w-full text-start">داش بورد</Link>}
                                </Dropdown.Item>
                                <Dropdown.Item><Link className='w-full text-start' href={'/order'}>المعاملات</Link></Dropdown.Item>
                ...
                <NavbarCollapse className='md:flex text-center md:relative rtl:text-right ltr:text-left'>
                    <NavbarLink className='mx-5 border-b md:border-none text-xl' href="/">
                        الرائسية
                    </NavbarLink>
                    <NavbarLink className=' border-b md:border-none text-xl' href="/About">معلومات عنا </NavbarLink>
                    <NavbarLink className=' border-b md:border-none text-xl' href="#">خدمات</NavbarLink>
                    <NavbarLink className=' border-b md:border-none text-xl' href="#">تيم العمل</NavbarLink>
                    <NavbarLink className=' border-b md:border-none text-xl' href="#">الاتصال</NavbarLink>
                </NavbarCollapse>
            </Navbar>
            <Dialog setOpenModal={setOpenModal} openModal={openModal} />
        </>
    );
}
